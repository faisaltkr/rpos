<template>
  <div
    class="w-full h-screen overflow-hidden flex min-h-screen flex-col items-center justify-center bg-gray-50"
  >
        ...
        <div class="flex min-h-full flex-1 flex-col justify-center">
          <div class="sm:mx-auto sm:w-full sm:max-w-sm">
            <img
              ...
              src="../../public/images/exone_logo.jpg"
              alt="Your Company"
            />
            <h2
                  ...
                  <span v-else>
                    ...
                    >
                      ...
                      <path
                        class="opacity-75"
                        fill="currentColor"
                        d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.961 7.961 0 014 12H0c0 3.042 1.135 5.824 3 7.937l3-2.646z"
                      ></path>
                    </svg>
                  </span>
    ...
    login() {
      ...
      axios
        ...
        .then((response) => {
          ...
          if (response.data.message.success == true) {
            ...
            localStorage.setItem(
              "pos",
              JSON.stringify(response.data.message.pos_profile_details)
            );
            localStorage.setItem(
              "user",
            ...
            axios
              ...
              const companyURL = this.baseURL +`/api/resource/Company/${this.companyName}`;
            axios
              .get(companyURL, {
                headers: {
                  Authorization: `Basic ${localStorage.getItem("token")}`,
              ...
              .then((result) => {
                ...
                const companyData = JSON.stringify(company); // Pretty print JSON
        ...
        .catch((error) => {
          ...
          // Call the function with the desired company name
        });
    },
  },
};
